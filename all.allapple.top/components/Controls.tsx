  ...
  return (
    <div className="absolute inset-0 pointer-events-none z-40 flex flex-col justify-between p-4">
        ...
        <div className="absolute right-2 bottom-20 flex flex-col gap-4 pointer-events-auto items-center">
            ...
            <div className="w-10 h-10 rounded-full bg-gradient-to-tr from-gray-800 to-gray-600 border-2 border-white/20 flex items-center justify-center animate-spin-slow mt-2 shadow-lg">
                 <Music size={16} />
            </div>
        </div>
...
const ActionItem = ({ onClick, children, label, tooltip }: { onClick: () => void; children: React.ReactNode; label: string; tooltip?: string }) => (
    <div 
