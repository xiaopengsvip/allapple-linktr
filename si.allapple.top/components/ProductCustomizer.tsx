      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
        ...
        <div className="relative group">
          ...
          <div className={`relative w-full aspect-square md:aspect-[4/3] rounded-2xl overflow-hidden bg-gradient-to-b from-white/5 to-transparent border border-white/10`}>
            ...
            <div className="absolute bottom-3 left-3 right-3 md:bottom-6 md:left-6 md:right-6 pointer-events-none z-10">
              <h3 className="text-lg md:text-3xl font-orbitron font-bold text-white mb-1 md:mb-2">{selectedColor.name[lang]}</h3>
              <div className="flex items-center gap-2">
                 <p className="text-[10px] md:text-sm text-white/90 bg-white/10 px-2 py-0.5 md:px-3 md:py-1 rounded backdrop-blur-md border border-white/20 tracking-wider uppercase flex items-center gap-1.5">
        ...
        <div className="space-y-8 md:space-y-10">
          ...
          <div>
            ...
            <button className="w-full py-4 md:py-5 bg-white text-black font-bold rounded-xl md:rounded-2xl hover:bg-accent hover:text-white transition-all duration-300 shadow-[0_6px_24px_0_rgba(0,0,0,0.1)] hover:shadow-[0_6px_24px_0_rgba(0,113,227,0.1)] text-base md:text-lg uppercase tracking-wide">
